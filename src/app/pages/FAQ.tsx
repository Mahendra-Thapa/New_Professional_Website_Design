      ...
      <section className="py-16 bg-[#F8FAFF]">
        <div className="max-w-2xl mx-auto px-6 text-center">
          <div className="bg-white border border-[#E2EAF4] rounded-2xl p-10 shadow-sm">
            ...
            <Link to="/contact" className="inline-flex items-center gap-2 bg-[#FF6F00] hover:bg-orange-600 text-white font-bold px-7 py-3.5 rounded-xl transition-all hover:shadow-lg hover:shadow-orange-500/25">
              Get in Touch
            </Link>
          </div>
        </div>
