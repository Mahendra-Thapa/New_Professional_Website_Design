      ...
      <section id="apply" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16">
          ...
          <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
            ...
            {/* Map placeholder */}
            <div className="rounded-2xl overflow-hidden border border-[#E2EAF4] h-52 bg-[#E8F0FE] flex flex-col items-center justify-center gap-2">
              <MapPin className="text-[#0D47A1]" size={28} />
              <p className="text-[#0D47A1] font-bold text-sm">Subidhanagar, Tinkune, Kathmandu</p>
              <p className="text-[#5A7098] text-xs">MSP Solution Pvt. Ltd.</p>
            </div>
          </motion.div>
        </div>
      </section>
